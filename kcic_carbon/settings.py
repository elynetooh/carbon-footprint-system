"""
Django settings for kcic_carbon project.
...
SECRET_KEY = 'django-insecure-9y&t2bgoejuju90m98#n#hd7-!uuy+m$z#@xuywcz5x2b7x$%='
...
ROOT_URLCONF = 'kcic_carbon.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
       'DIRS': [BASE_DIR / 'footprint' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'kcic_carbon.wsgi.application'
